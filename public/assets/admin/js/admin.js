		...
		function init_knob() {
			...
			function init_SmartWizard() {
				...
				function validateSteps(stepnumber){
					...
					// validar paso 1
					if(stepnumber == 1){
						var employee_rut= $("#employee_rut").text();
						var employee_name= $("#employee_name").text();
						var employee_phone= $("#employee_phone").text();
						var employee_email= $("#employee_email").text();
						if(employee_rut!=""){	
							//agregamos datos a la etapa 4
							$("#contract_datos1").html("<address> <br><b>Empleado: </b>"+employee_name+"<br><b>Rut: </b>"
								+employee_rut+"<br><b>Teléfono: </b>"+employee_phone+"<br><b>Correo: </b>"+employee_email+"</address> ");			        		  
