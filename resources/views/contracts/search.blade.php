				...
				<div class="x_panel">
					...
					<div class="x_content">
						...
						<div class="col-md-6 col-xs-12 invoice-col">
							<div class="btn-group">
								<button data-toggle="dropdown" class="btn btn-success dropdown-toggle btn" type="button">Generar Excel <span class="caret"></span>
								</button>
								<ul role="menu" class="dropdown-menu">
									<li><a href="{{ route('contracts.excelContracts') }}">Contratos</a>
									</li>
									<li><a href="{{ route('contracts.excelBudgets') }}">Presupuestos</a>
									</li>
									<li><a href="{{ route('contracts.excelEmployees') }}">Nº Empleados</a>
									</li>                       
								</ul>
							</div>              
						</div>        
