 							...
 							<div id="wizard" class="form_wizard wizard_horizontal">
 											...
 											<div class="col-md-6 col-md-offset-3">
 												<div class="col-md-6 col-sm-6 col-xs-12   ">  
 													<div class="input-group">
 														<input id="rut_employee" type="text" placeholder="Ingrese Rut" maxlength="12" value="{{ $contract->employees->rut }}"  class="form-control @if($errors->has('rut_employee')) parsley-error @endif " name="rut_employee" >  
 												...
 												<div class="well profile_view">
 													<div class="col-sm-12">
 														...
 														<div class="left col-xs-12">
 															<h2 id="employee_name">{{ $contract->employees->names.' '.$contract->employees->last_name.' '.$contract->employees->last_name_mother}}</h2>                          
 															<ul class="list-unstyled">
 																<li id="employee_rut"><i class="fa fa-id-card-o"></i> {{  $contract->employees->rut}}</li>
 																<li id="employee_email"><i class="fa fa-envelope"></i> {{ $contract->employees->email}}</li>
 																<li id="employee_phone"><i class="fa fa-phone"></i> {{ $contract->employees->phone}}</li>
 															</ul>
 														</div>
 													</div>
 												</div>
 								...
 								<div id="step-3">
 									...
 									<div class="item form-group">
 										...
 										<div class="col-md-6 col-sm-6 col-xs-12">
 											<input id="position" value="{{ $contract->position }}" type="text" class="form-control col-md-7 col-xs-12 @if($errors->has('position')) parsley-error @endif"
 									...
 									<div class="item form-group">
 										...
 										<div class="col-md-6 col-sm-6 col-xs-12">  
 											<select class='form-control' id='function' name="function" required="">
 												<option value="">-- Por favor seleccione --</option>                  
 												<option {{( $contract->function =='Control de Competencia')?'selected' : ''}}  value="Control de Competencia">Control de Competencia</option> 
 												<option {{($contract->function=='Monitor')?'selected' : ''}} value="Monitor">Monitor</option>                
 												<option {{($contract->function=='Gestor Territorial')?'selected' : ''}}  value="Gestor Territorial">Gestor Territorial</option> 
 												<option {{($contract->function=='Administrador Contable')?'selected' : ''}} value="Administrador Contable">Administrador Contable</option>
 												<option {{($contract->function=='Coordimador')?'selected' : ''}} value="Coordimador">Coordimador</option>
 												<option {{($contract->function=='Encargado')?'selected' : ''}}  value="Encargado">Encargado</option> 
 												<option {{($contract->function=='Apoyo al Programa')?'selected' : ''}} value="Apoyo al Programa">Apoyo al Programa</option>
 												<option {{($contract->function=='Técnico')?'selected' : ''}} value="Técnico">Técnico</option>
 												<option {{($contract->function=='Ayudante Técnico')?'selected' : ''}}  value="Ayudante Técnico">Ayudante Técnico</option>   
 												<option {{($contract->function=='Delegado')?'selected' : ''}}  value="Delegado">Delegado</option>  
 												<option {{($contract->function=='Mecánico')?'selected' : ''}}  value="Mecánico">Mecánico</option> 
 											</select>                      
 										</div>
 									</div>
 									<div class="item form-group">
 										...
 										<div class="col-md-6 col-sm-6 col-xs-12">
 											<input id="sport" value="{{ $contract->sport }}" type="text" class="form-control col-md-7 col-xs-12 @if($errors->has('sport')) parsley-error @endif"
 											name="sport"  required>
 											@if($errors->has('sport'))
 											<ul class="parsley-errors-list filled">
 									...
 									<div class="item form-group">
 										...
 										<div class="col-md-6 col-sm-6 col-xs-12">  
 											<select class='form-control' id='duration' name="duration" required="">
 												<option value="">-- Por favor seleccione --</option>  
 												<option {{($contract->duration=='Transitorio')?'selected' : ''}}  value="Transitorio">Transitorio</option>  
 												<option {{($contract->duration=='Permanente')?'selected' : ''}}  value="Permanente">Permanente</option> 
 											</select>                      
 										</div>
 									</div>
 									...
 									<div class="item form-group">
 										...
 										<div class="col-md-6 col-sm-6 col-xs-12">
 											<input id="amount_year" value="{{ $contract->amount_year }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('amount_year')) parsley-error @endif"
 									...
 									<div class="item form-group">
 										...
 										<div class="col-md-6 col-sm-6 col-xs-12">
 											<input id="amount_month" value="{{ $contract->amount_month }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('amount_month')) parsley-error @endif"
 									...
 									<div class="item form-group">
 										...
 										<div class="col-md-6 col-sm-6 col-xs-12">
 											<input id="quotas" value="{{ $contract->quotas }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('quotas')) parsley-error @endif"
 									...
 									<div class="item form-group">
 										...
 										<div class="col-md-6 col-sm-6 col-xs-12">
 											<input id="hours" value="{{ $contract->hours }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('hours')) parsley-error @endif"
 											name="hours"  required>
 											@if($errors->has('hours'))
 											<ul class="parsley-errors-list filled">
 									...
 									<div class="item form-group">
 										...
 										<div class="col-md-6 col-sm-6 col-xs-12">
 											<input id="date_start" type="text" value="{{ $contract->date_start }}" data-inputmask="'mask': '99/99/9999'" class="form-control col-md-7 col-xs-12 @if($errors->has('date_start')) parsley-error @endif"
 									...
 									<div class="item form-group">
 										...
 										<div class="col-md-6 col-sm-6 col-xs-12">
 											<input id="date_finish" type="text" value="{{ $contract->date_finish }}" data-inputmask="'mask': '99/99/9999'" class="form-control col-md-7 col-xs-12 @if($errors->has('date_finish')) parsley-error @endif"
