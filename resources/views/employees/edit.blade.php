			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="x_content">               
						...
						<form class="form-horizontal form-label-left" role="form" method="POST" accept-charset="UTF-8" enctype="multipart/form-data" action="{{ url('/empleados/editar') }}">
							{!! csrf_field() !!} 
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input id="names" value="{{ $employee->names }}" type="text" class="form-control col-md-7 col-xs-12 @if($errors->has('names')) parsley-error @endif"
									name="names"  required>
									@if($errors->has('names'))
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input id="last_name" type="text" value="{{ $employee->last_name }}" class="form-control col-md-7 col-xs-12 @if($errors->has('last_name')) parsley-error @endif"
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input id="last_name_mother" type="text" value="{{ $employee->last_name_mother }}"class="form-control col-md-7 col-xs-12 @if($errors->has('last_name_mother')) parsley-error @endif"
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input id="rut" type="text"  maxlength="12" value="{{ $employee->rut }}" class="form-control col-md-7 col-xs-12 @if($errors->has('rut')) parsley-error @endif" name="rut"  required>
									@if($errors->has('rut'))
									<ul class="parsley-errors-list filled">
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input id="email" type="email"  value="{{ $employee->email }}" class="form-control col-md-7 col-xs-12 @if($errors->has('email')) parsley-error @endif"
									name="email"  required>
									@if($errors->has('email'))
									<ul class="parsley-errors-list filled">
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input id="phone" type="text" value="{{ $employee->phone}}" data-inputmask="'mask' : '(9)-99999999', 'placeholder': '(x)-xxxxxxxx'" class="form-control col-md-7 col-xs-12 @if($errors->has('phone')) parsley-error @endif"
									name="phone"  required>
									@if($errors->has('phone'))
									<ul class="parsley-errors-list filled">
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input id="address" type="text" value="{{ $employee->address }}" class="form-control col-md-7 col-xs-12 @if($errors->has('address')) parsley-error @endif"
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input id="commune" type="text" value="{{ $employee->commune }}" class="form-control col-md-7 col-xs-12 @if($errors->has('commune')) parsley-error @endif"
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input id="city" type="text" value="{{ $employee->city }}" class="form-control col-md-7 col-xs-12 @if($errors->has('city')) parsley-error @endif"
									name="city"  required>
									@if($errors->has('city'))
									<ul class="parsley-errors-list filled">
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input id="birth_date" type="text" value="{{ $employee->birth_date }}" data-inputmask="'mask': '99/99/9999'" class="form-control col-md-7 col-xs-12 @if($errors->has('birth_date')) parsley-error @endif"
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">  
									<select class='form-control' id='afp' name="afp" required="">
										...
										@foreach($afps as $afp)
										<option {{( $employee->afp_id==$afp->id )?'selected' : ''}} value="{{ $afp->id }}">{{ $afp->name }}</option>
										@endforeach
									</select>                      
								</div>
							</div>	
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">  
									<select class='form-control' id='health' name="health" required="">
										...
										<option  {{( $employee->health_id==$health->id )?'selected' : ''}} value="{{ $health->id }}">{{ $health->name }}</option>
										@endforeach
									</select>                      
								</div>
							</div>   
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input id="profession" type="text" value="{{ $employee->profession }}" class="form-control col-md-7 col-xs-12 @if($errors->has('profession')) parsley-error @endif"
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">  
									<select class='form-control' id='quality_studies' name="quality_studies" required="">
										<option value="">-- Por favor seleccione --</option>									
										<option {{( $employee->quality_studies =='Técnico')?'selected' : ''}}  value="Técnico">Técnico</option>	
										<option {{($employee->quality_studies=='Profesional')?'selected' : ''}} value="Profesional">Profesional</option>
										<option {{($employee->quality_studies=='Experto')?'selected' : ''}} value="Experto">Experto</option>
									</select>                      
								</div>
							</div>
							<div class="item form-group" id='semesters_div'  @if($employee->semesters==null) hidden @endif >
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="semesters" >
									Semestres
									<span class="required">*</span>
								</label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input id="semesters" type="number" value="{{ $employee->semesters }}" class="form-control col-md-7 col-xs-12 @if($errors->has('semesters')) parsley-error @endif"
									name="semesters" >
							...
							<div id="cedula_div" class="form-group" hidden>
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="semestres">Adjuntar cedula de identidad
								</label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<div class="btn-group">                                    
							...
							<div id="certificado_div" class="form-group" hidden>
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="semestres">Adjuntar certificado
								</label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<div class="btn-group">
