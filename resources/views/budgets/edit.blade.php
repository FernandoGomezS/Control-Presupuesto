							...
							<div id="wizard_verticle" class="form_wizard wizard_verticle">
								...
								<div id="step-11">
									...
									<div class="item form-group">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
											<input id="year" type="number" value= "{{ $budget->year }}"   class="form-control col-md-7 col-xs-12 @if($errors->has('year')) parsley-error @endif"
											name="year"  required>
											@if($errors->has('year'))
									...
									<div class="item form-group">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
											<input id="amount_total" value="{{ $budget->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('amount_total')) parsley-error @endif"
									...
									<div class="item form-group">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
											<input id="numbers_employees" value="{{ $budget->numbers_employees }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('numbers_employees')) parsley-error @endif"
									...
									<div class="item form-group">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">  
											<select class='form-control' id='state' name="state" required="">
												...
												<option @if($budget->state=='Activo') selected="selected"@endif value="Activo">Activo</option>	
										<option @if($budget->state=='Inactivo') selected="selected" @endif value="Inactivo">Inactivo</option>
											</select>                      
										</div>
									</div>	        
								...
								<div id="step-22">
									...
									<div class="item form-group">
										...
										<div class="col-md-3 col-sm-6 col-xs-12">
											<input id="employees_school_competition" value="{{ $components[0]->numbers_employees }}" type="number" class="form-control col-md-7 col-xs-12 "
										...
										<div class="col-md-3 col-sm-6 col-xs-12">
											<input id="amount_school_competition" value="{{ $components[0]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('amount_school_competition')) parsley-error @endif"
									...
									<div class="item form-group">
										...
										<div class="col-md-3 col-sm-6 col-xs-12">
											<input id="employees_federated_competition" value="{{ $components[1]->numbers_employees }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('employees_federated_competition')) parsley-error @endif"
										...
										<div class="col-md-3 col-sm-6 col-xs-12">
											<input id="amount_federated_competition" value="{{ $components[1]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('amount_federated_competition')) parsley-error @endif"
									...
									<div class="item form-group">
										...
										<div class="col-md-3 col-sm-6 col-xs-12">
											<input id="employees_school_sup_competition" value="{{ $components[2]->numbers_employees }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('employees_school_sup_competition')) parsley-error @endif"
										...
										<div class="col-md-3 col-sm-6 col-xs-12">
											<input id="amount_school_sup_competition" value="{{ $components[2]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('amount_school_sup_competition')) parsley-error @endif"
								...
								<div id="step-33">
									...
									<div class="item form-group">
										...
										<div class="col-md-3 col-sm-6 col-xs-12">
											<input id="amount_stage_communal" value="{{ $typeStages1[0]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('amount_stage_communal')) parsley-error @endif"
										...
										<div class="col-md-3 col-sm-6 col-xs-12">
											<input id="amount_stage_provincial" value="{{ $typeStages1[1]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('amount_stage_provincial')) parsley-error @endif"
									...
									<div class="item form-group">
										...
										<div class="col-md-3 col-sm-6 col-xs-12">
											<input id="amount_stage_regional" value="{{ $typeStages1[2]->amount_total  }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('amount_stage_regional')) parsley-error @endif"
										...
										<div class="col-md-3 col-sm-6 col-xs-12">
											<input id="amount_stage_national" value="{{ $typeStages1[3]->amount_total  }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('amount_stage_national')) parsley-error @endif"
									...
									<div class="item form-group">
										...
										<div class="col-md-3 col-sm-6 col-xs-12">
											<input id="amount_stage_games" value="{{ $typeStages1[4]->amount_total  }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('amount_stage_games')) parsley-error @endif"
									...
									<div class="col-md-3 col-sm-6 col-xs-12">
										<input id="amount_stage_preparation" value="{{ $typeStages2[0]->amount_total  }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('amount_stage_preparation')) parsley-error @endif"
									...
									<div class="col-md-3 col-sm-6 col-xs-12">
										<input id="amount_stage_participation" value="{{ $typeStages2[1]->amount_total}}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('amount_stage_participation')) parsley-error @endif"
								...
								<div class="item form-group">
									...
									<div class="col-md-3 col-sm-6 col-xs-12">
										<input id="amount_stage_regional_sup" value="{{ $typeStages3[0]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('amount_stage_regional_sup')) parsley-error @endif"
									...
									<div class="col-md-3 col-sm-6 col-xs-12">
										<input id="amount_stage_ldes" value="{{ $typeStages3[1]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('amount_stage_ldes')) parsley-error @endif"
									...
									<div id="myTabContent" class="tab-content">
										<div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
											...
											<div class="item form-group">
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_1" value="{{ $stages1[0]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_1')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_2" value="{{ $stages1[1]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('numbers_employees')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_3" value="{{ $stages1[2]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_3')) parsley-error @endif"
											...
											<div class="item form-group">
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_4" value="{{ $stages1[3]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_4')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_5" value="{{ $stages1[4]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_5')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_6" value="{{ $stages1[5]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_6')) parsley-error @endif"
											...
											<div class="item form-group">
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_7" value="{{ $stages1[6]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_7')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_8" value="{{ $stages1[7]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_8')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_9" value="{{ $stages1[8]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_9')) parsley-error @endif"
											...
											<div class="item form-group">
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_10" value="{{ $stages1[9]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_10')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_11" value="{{ $stages1[10]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_11')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_12" value="{{ $stages1[11]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_12')) parsley-error @endif"
											...
											<div class="item form-group">
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_13" value="{{ $stages1[12]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_13')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_14" value="{{ $stages1[13]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_14')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_15" value="{{ $stages1[14]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_15')) parsley-error @endif"
											...
											<div class="item form-group">
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_16" value="{{ $stages1[15]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_16')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_17" value="{{ $stages1[16]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_17')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_18" value="{{ $stages1[17]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_18')) parsley-error @endif"
											...
											<div class="item form-group">
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_19" value="{{ $stages1[18]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_19')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_20" value="{{ $stages1[19]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_20')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_21" value="{{ $stages1[20]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_21')) parsley-error @endif"
											...
											<div class="item form-group">
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_22" value="{{ $stages1[21]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_22')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_23" value="{{ $stages1[22]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_23')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_24" value="{{ $stages1[23]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_24')) parsley-error @endif"
											...
											<div class="item form-group">
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_25" value="{{ $stages1[24]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_25')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_26" value="{{ $stages1[25]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_26')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_27" value="{{ $stages1[26]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_27')) parsley-error @endif"
											...
											<div class="item form-group">
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_28" value="{{ $stages1[27]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_28')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_29" value="{{ $stages1[28]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_29')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_30" value="{{ $stages1[29]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_30')) parsley-error @endif"
											...
											<div class="item form-group">
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_31" value="{{ $stages1[30]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_31')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_32" value="{{ $stages1[31]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_32')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_33" value="{{ $stages1[32]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_33')) parsley-error @endif"
											...
											<div class="item form-group">
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_34" value="{{ $stages1[33]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_34')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_35" value="{{ $stages1[34]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_35')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_36" value="{{ $stages1[35]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_36')) parsley-error @endif"
											...
											<div class="item form-group">
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_37" value="{{ $stages1[36]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_37')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_38" value="{{ $stages1[37]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_38')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_39" value="{{ $stages1[38]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_39')) parsley-error @endif"
											...
											<div class="item form-group">
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_40" value="{{ $stages1[39]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_40')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_41" value="{{ $stages1[40]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_41')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_42" value="{{ $stages1[41]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_42')) parsley-error @endif"
											...
											<div class="item form-group">
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_43" value="{{ $stages1[42]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_43')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_44" value="{{ $stages1[43]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_44')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_45" value="{{ $stages1[44]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_45')) parsley-error @endif"
											...
											<div class="item form-group">
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_46" value="{{ $stages1[45]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_46')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_47" value="{{ $stages1[46]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_47')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_48" value="{{ $stages1[47]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_48')) parsley-error @endif"
											...
											<div class="item form-group">
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_49" value="{{ $stages1[48]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_49')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_50" value="{{ $stages1[49]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_50')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_51" value="{{ $stages1[50]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_51')) parsley-error @endif"
											...
											<div class="item form-group">																			
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="comunal_52" value="{{ $stages1[51]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('comunal_52')) parsley-error @endif"
										...
										<div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
											...
											<div class="item form-group">
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="provincial_1" value="{{ $stages2[0]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('provincial_1')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="provincial_2" value="{{ $stages2[1]->amount_total}}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('provincial_2')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="provincial_3" value="{{ $stages2[2]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('provincial_3')) parsley-error @endif"
											...
											<div class="item form-group">
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="provincial_4" value="{{ $stages2[3]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('provincial_4')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="provincial_5" value="{{ $stages2[4]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('provincial_5')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="provincial_6" value="{{ $stages2[5]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('provincial_6')) parsley-error @endif"
											...
											<div class="item form-group">
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="provincial_7" value="{{ $stages2[6]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('provincial_7')) parsley-error @endif"
										...
										<div role="tabpanel" class="tab-pane fade" id="tab_content3" aria-labelledby="profile-tab">
											...
											<div class="item form-group">
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="regional_1" value="{{ $stages3[0]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('regional_1')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="regional_2" value="{{ $stages3[1]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('regional_2')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="regional_3" value="{{ $stages3[2]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('regional_3')) parsley-error @endif"
											...
											<div class="item form-group">
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="regional_4" value="{{ $stages3[3]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('regional_4')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="regional_5" value="{{ $stages3[4]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('regional_5')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="regional_6" value="{{ $stages3[5]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('regional_6')) parsley-error @endif"
											...
											<div class="item form-group">
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="regional_7" value="{{ $stages3[6]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('regional_7')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="regional_8" value="{{ $stages3[7]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('regional_8')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="regional_9" value="{{ $stages3[8]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('regional_9')) parsley-error @endif"
											...
											<div class="item form-group">
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="regional_10" value="{{ $stages3[9]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('regional_10')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="regional_11" value="{{ $stages3[10]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('regional_11')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="regional_12" value="{{ $stages3[11]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('regional_12')) parsley-error @endif"
										...
										<div role="tabpanel" class="tab-pane fade" id="tab_content4" aria-labelledby="profile-tab">
											...
											<div class="item form-group">
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="nacional_1" value="{{ $stages4[0]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('nacional_1')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="nacional_2" value="{{ $stages4[1]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('nacional_2')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="nacional_3" value="{{ $stages4[2]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('nacional_3')) parsley-error @endif"
											...
											<div class="item form-group">
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="nacional_4" value="{{ $stages4[3]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('nacional_4')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="nacional_5" value="{{ $stages4[4]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('nacional_5')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="nacional_6" value="{{ $stages4[5]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('nacional_6')) parsley-error @endif"
											...
											<div class="item form-group">
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="nacional_7" value="{{ $stages4[6]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('nacional_7')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="nacional_8" value="{{ $stages4[7]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('nacional_8')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="nacional_9" value="{{ $stages4[8]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('nacional_9')) parsley-error @endif"
											...
											<div class="item form-group">
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="nacional_10" value="{{ $stages4[9]->amount_total  }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('nacional_10')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="nacional_11" value="{{ $stages4[10]->amount_total  }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('nacional_11')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="nacional_12" value="{{ $stages4[11]->amount_total  }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('nacional_12')) parsley-error @endif"
										...
										<div role="tabpanel" class="tab-pane fade" id="tab_content5" aria-labelledby="profile-tab">
											...
											<div class="item form-group">
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="juegos_1" value="{{ $stages5[0]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('juegos_1')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="juegos_2" value="{{ $stages5[1]->amount_total}}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('juegos_2')) parsley-error @endif"
												...
												<div class="col-md-2 col-sm-6 col-xs-12">
													<input id="juegos_3" value="{{ $stages5[2]->amount_total }}" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('juegos_3')) parsley-error @endif"
