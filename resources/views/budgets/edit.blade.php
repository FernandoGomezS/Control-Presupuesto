				...
				<div class="x_panel">
					...
					<div class="x_content">  
						<form class="form-horizontal form-label-left" role="form" method="POST" action="{{ url('/presupuestos/editar') }}">
							...
							<h4 class="section">Editar la Información</h4>
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input id="year" type="number"  class="form-control col-md-7 col-xs-12 @if($errors->has('year')) parsley-error @endif"
									name="year" value="{{ $budget->year }}" required>
									@if($errors->has('year'))
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									...
									name="amount_total" value="{{ $budget->amount_total }}" required>
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									...
									name="numbers_employees" value="{{ $budget->numbers_employees }}" required>
