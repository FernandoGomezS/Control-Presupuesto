			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="x_content">               
						...
						<form class="form-horizontal form-label-left" role="form" method="POST" action="{{ url('/responsables/editar') }}">
							{!! csrf_field() !!}   
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input id="names" value="{{ $responsable->names }}" type="text" class="form-control col-md-7 col-xs-12 @if($errors->has('names')) parsley-error @endif"
									name="names"  required>
									@if($errors->has('names'))
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input id="last_name" type="text" value="{{ $responsable->last_name }}" class="form-control col-md-7 col-xs-12 @if($errors->has('last_name')) parsley-error @endif"
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input id="last_name_mother" type="text" value="{{ $responsable->last_name_mother }}"class="form-control col-md-7 col-xs-12 @if($errors->has('last_name_mother')) parsley-error @endif"
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input id="rut" type="text"  maxlength="12" value="{{ $responsable->rut }}" class="form-control col-md-7 col-xs-12 @if($errors->has('rut')) parsley-error @endif" name="rut"  required>
									@if($errors->has('rut'))
									<ul class="parsley-errors-list filled">
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input id="email" type="email"  value="{{ $responsable->email }}" class="form-control col-md-7 col-xs-12 @if($errors->has('email')) parsley-error @endif"
									name="email"  required>
									@if($errors->has('email'))
									<ul class="parsley-errors-list filled">
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input id="phone" type="text" value="{{ $responsable->phone }}" data-inputmask="'mask' : '(+99)-9-99999999', 'placeholder': '(+56)-9-99999999'" class="form-control col-md-7 col-xs-12 @if($errors->has('phone')) parsley-error @endif"
									name="phone"  required>
									@if($errors->has('phone'))
									<ul class="parsley-errors-list filled">
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input id="address" type="text" value="{{ $responsable->address}}" class="form-control col-md-7 col-xs-12 @if($errors->has('address')) parsley-error @endif"
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input id="birth_date" type="text" value="{{ $responsable->birth_date }}" data-inputmask="'mask': '99/99/9999'" class="form-control col-md-7 col-xs-12 @if($errors->has('birth_date')) parsley-error @endif"
